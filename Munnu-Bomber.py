...
# Author: MunnuOne Inc.
# GitHub: https://github.com/MunnuOne
# Version: 4.0.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Munnuone/munnu/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf MunnuOne && git clone https://github.com/munnuone/munnu > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd MunnuOne && python Tbomb.py")
...
───────────────────  \033[94m   │".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : MunnuOne Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/MunnuOne\033[94m│".center(columns+9))
